...
transcript_source: "https://lexfridman.com/jensen-huang-transcript/"
episode_url: "https://lexfridman.com/jensen-huang/"
author:
  - "[[Lex Fridman]]"
guest:
  - "[[Jensen Huang]]"
...
analysis_report: '[[Lex Fridman - Jensen Huang：NVIDIA – The $4 Trillion Company & the AI Revolution]]'
tags:
  - "transcript"
---
...
**38:51** · Jensen Huang: You know, our computer price is going up, but our token generation effectiveness is going up so much faster that token cost is coming down. It’s just coming down an order of magnitude every year.

**39:04** · Lex Fridman: So power, that’s an interesting one. So the way to try to get around the power blocker is to try to, with the tokens per second per watt, try to make it more and more efficient. Of course, there’s the question of how do we get more power.

**39:16** · Jensen Huang: We should also get more power.


### Supply chain

**39:17** · Lex Fridman: That’s a really complicated one. You’ve talked about small modular nuclear power plants. There’s all kinds of ideas for energy. How much does it keep you up at night? The bottlenecks in the supply chain of AI, like ASML with EUV lithography machines, TSMC with advanced packaging like CoWoS, and SK Hynix with the high bandwidth memory?
