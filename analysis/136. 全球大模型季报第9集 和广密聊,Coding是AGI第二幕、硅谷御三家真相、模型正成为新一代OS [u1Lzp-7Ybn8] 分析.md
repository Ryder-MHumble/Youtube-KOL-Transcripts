---
title: 136. 全球大模型季报第9集：和广密聊，Coding是AGI第二幕、硅谷御三家真相、模型正成为新一代OS（外部迁移分析）
source: repository_import
youtube_url: https://www.youtube.com/watch?v=u1Lzp-7Ybn8
video_id: u1Lzp-7Ybn8
transcript: '[[136. 全球大模型季报第9集 和广密聊,Coding是AGI第二幕、硅谷御三家真相、模型正成为新一代OS [u1Lzp-7Ybn8]]]'
source_repository: https://github.com/nolimitkun/ai-kol-wiki
source_wiki: https://github.com/nolimitkun/ai-kol-wiki/blob/main/wiki/videos/20260415-zhang-xiaojun-guangmi-llm-quarterly-9.md
tags:
- kol情报
- imported
- ai-kol-wiki
...
对应逐字稿：[[136. 全球大模型季报第9集 和广密聊,Coding是AGI第二幕、硅谷御三家真相、模型正成为新一代OS [u1Lzp-7Ybn8]]]
来源视频：[YouTube](https://www.youtube.com/watch?v=u1Lzp-7Ybn8) · 视频 ID：`u1Lzp-7Ybn8`
原始 Wiki：[ai-kol-wiki](https://github.com/nolimitkun/ai-kol-wiki/blob/main/wiki/videos/20260415-zhang-xiaojun-guangmi-llm-quarterly-9.md)

## 迁移说明

本文件由 `nolimitkun/ai-kol-wiki` 的公开 Wiki 页面迁移生成。原始观点摘要与时间戳保持来源项目的表达；本文件不是本地浏览器插件捕获的 canonical 分析，后续复核应以逐字稿为准。

> "全球大模型季报"是张小珺与广密连续三年、每季度一次的对谈系列，用季报形式记录大模型技术进展与趋势。本第 9 集站在 2026 年 Q1，给出**硅谷一线体感**下对 Coding 爆发、三大实验室战略、模型即操作系统、以及白领失业窗口的系统判断，是本库 [中美 AI 生态对照](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/china-us-ai.md)、[AI 商业化与价值捕获](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/ai-business-and-value-capture.md)、[LLM OS](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/llm-os.md)、[AI 与就业](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/ai-and-jobs.md) 的重要中方素材。
...
- **AGI 路线图分三幕**：第一幕 **Chatbot**（ChatGPT，能对话/联网，商业价值有限）→ 第二幕 **Coding Agent**（能直接干活、干高价值任务，本质"能帮我们干活了"）→ 第三幕 **Automated AI Researcher**（AI 自动化 AI 研究，去解决脑科学/材料学等基础科学）（[01:14:10]–[01:15:11]、[00:52:43]）。
- **Coding 不是垂直场景，而是 AGI 路线图里的"加速器/打药"**："领先的 Coding 模型就像领先的 GPU"，模型公司若不重视 coding"大概会掉出第一梯队"（[00:12:21]）。
- **"语言即世界，代码即方案"**：自然语言是对世界的描述、code 是对 solution 的描述；只有语言和代码的泛化性被充分证明，数学能表达的东西太有限（[00:11:19]、[00:15:21]）。Coding 之所以最先跑出来，是因为 **feedback loop 最短、最清晰**（[00:13:21]）——呼应 [姚顺宇](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/yao-shunyu.md)"coding reward signal 清晰"。
...
- 弱点：SAM 是 VC 出身、容易摊大饼/FOMO（多模态、Sora 抢资源）；文化 value 0→1 不 value 1→100，"没人做脏活累活搞数据"；ChatGPT"很成功但没有灵魂"（[00:41:37]–[00:44:39]）。
...
- **Coding 的 reward loop 清晰**：与 [姚顺宇](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/yao-shunyu.md)（coding 因 reward signal 清晰而快进）、[朱邦华](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/banghua-zhu.md)（RLVR 针对可验证领域）一致，见 [评估与 Benchmark](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/evaluation-and-benchmarks.md)、[LLM 训练管线](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/llm-training-pipeline.md)。
- **模型即操作系统**：与 [Karpathy 的 LLM OS](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/llm-os.md)、[Mark Chen](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/mark-chen.md)"模型是新 OS"呼应；广密从投资/商业角度给出"global GDP OS"版本。
- **Anthropic top-down vs OpenAI bottom-up**：与 [姚顺宇](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/yao-shunyu.md)、[Mark Chen](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/mark-chen.md) 对实验室文化的观察互补，见 [AI 实验室文化与组织](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/ai-lab-culture.md)。
- **AR/价值捕获**：与 [Benedict Evans](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/a16z.md)、[Freda](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/freda-duan.md) 的商业化讨论对话，见 [AI 商业化与价值捕获](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/ai-business-and-value-capture.md)。
- **白领失业**：与 [Alex Imas & Phil Trammell](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/imas-trammell.md)、[Benedict Evans](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/a16z.md) 的 AI 经济学对照，见 [AI 与就业](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/ai-and-jobs.md)。广密的判断显著更激进（30% 岗位、researcher 自身失业）。
- **中美产品 vs 技术分工**：与 [姚顺宇](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/yao-shunyu.md)、[阳萌](https://github.com/nolimitkun/ai-kol-wiki/blob/main/people/yangmeng-steven.md) 一致（中国强产品、硅谷强底层），见 [中美 AI 生态对照](https://github.com/nolimitkun/ai-kol-wiki/blob/main/topics/china-us-ai.md)。
